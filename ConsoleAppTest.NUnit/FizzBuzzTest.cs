...
namespace ConsoleAppTest.NUnit
{
    public class FizzBuzzTest
    {
        ...
        public void Compute(int count, string expectedString)
        {
            //Act
            var restult = FizzBuzz.Compute(count);

            //Assert
            var resultString = string.Join(" ", restult);
